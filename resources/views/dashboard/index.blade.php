...
<div class="main-content">
    <section class="section">
      ...
      <div class="section-header">
        ...
        @hasrole('student')
        <div class="section-header">
          <h1>Anda akan dialihkan dalam : </h1>
      </div>
        <h3>Tata tertib peserta</h3>
        <ul>
          <li>Peserta yang dapat menjalani TKD adalah peserta yang namanya tertuang dalam daftar hadir dan terdaftar pada waktu dan Tempat Uji Kompetensi yang telah ditentukan</li>
